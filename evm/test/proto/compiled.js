...
$root.ClientState = (function() {
    ...
    ClientState.encode = function encode(message, writer) {
        ...
        if (message.trustLevel != null && Object.hasOwnProperty.call(message, "trustLevel"))
            $root.Fraction.encode(message.trustLevel, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
        if (message.trustingPeriod != null && Object.hasOwnProperty.call(message, "trustingPeriod"))
            writer.uint32(/* id 3, wireType 0 =*/24).int64(message.trustingPeriod);
        if (message.unbondingPeriod != null && Object.hasOwnProperty.call(message, "unbondingPeriod"))
            writer.uint32(/* id 4, wireType 0 =*/32).int64(message.unbondingPeriod);
        if (message.maxClockDrift != null && Object.hasOwnProperty.call(message, "maxClockDrift"))
        ...
        if (message.merklePrefix != null && Object.hasOwnProperty.call(message, "merklePrefix"))
            $root.MerklePrefix.encode(message.merklePrefix, writer.uint32(/* id 8, wireType 2 =*/66).fork()).ldelim();
        if (message.timeDelay != null && Object.hasOwnProperty.call(message, "timeDelay"))
...
$root.Header = (function() {
    ...
    Header.encode = function encode(message, writer) {
        ...
        if (message.trustedHeight != null && Object.hasOwnProperty.call(message, "trustedHeight"))
            $root.Height.encode(message.trustedHeight, writer.uint32(/* id 3, wireType 2 =*/26).fork()).ldelim();
        if (message.trustedValidators != null && Object.hasOwnProperty.call(message, "trustedValidators"))
...
$root.TokenTransfer = (function() {

    /**
     * Properties of a TokenTransfer.
     * @exports ITokenTransfer
     * @interface ITokenTransfer
     * @property {string|null} [srcChain] TokenTransfer srcChain
     * @property {string|null} [destChain] TokenTransfer destChain
     * @property {string|null} [sender] TokenTransfer sender
     * @property {string|null} [receiver] TokenTransfer receiver
     * @property {Uint8Array|null} [amount] TokenTransfer amount
     * @property {string|null} [token] TokenTransfer token
     * @property {string|null} [oriToken] TokenTransfer oriToken
     */
     ...
     * @constructor
     * @param {ITokenTransfer=} [properties] Properties to set
     */
    ...
    /**
     * TokenTransfer srcChain.
     * @member {string} srcChain
     * @memberof TokenTransfer
     * @instance
     */
    TokenTransfer.prototype.srcChain = "";

    /**
     * TokenTransfer destChain.
     * @member {string} destChain
     * @memberof TokenTransfer
     * @instance
     */
    TokenTransfer.prototype.destChain = "";
     ...
     * @instance
     */
    TokenTransfer.prototype.sender = "";
     ...
     * @instance
     */
    TokenTransfer.prototype.receiver = "";
     ...
     * @instance
     */
    TokenTransfer.prototype.amount = $util.newBuffer([]);
     ...
     * @instance
     */
    TokenTransfer.prototype.token = "";

    /**
     * TokenTransfer oriToken.
     * @member {string} oriToken
     * @memberof TokenTransfer
     * @instance
     */
    TokenTransfer.prototype.oriToken = "";
     ...
     * @static
     * @param {ITokenTransfer=} [properties] Properties to set
     * @returns {TokenTransfer} TokenTransfer instance
     */
    ...
    /**
     * Encodes the specified TokenTransfer message. Does not implicitly {@link TokenTransfer.verify|verify} messages.
     * @function encode
     * @memberof TokenTransfer
     * @static
     * @param {ITokenTransfer} message TokenTransfer message or plain object to encode
     * @param {$protobuf.Writer} [writer] Writer to encode to
     * @returns {$protobuf.Writer} Writer
     */
    TokenTransfer.encode = function encode(message, writer) {
        ...
        if (message.oriToken != null && Object.hasOwnProperty.call(message, "oriToken"))
            writer.uint32(/* id 7, wireType 2 =*/58).string(message.oriToken);
        return writer;
    };

    /**
     * Encodes the specified TokenTransfer message, length delimited. Does not implicitly {@link TokenTransfer.verify|verify} messages.
     * @function encodeDelimited
     * @memberof TokenTransfer
     * @static
     * @param {ITokenTransfer} message TokenTransfer message or plain object to encode
     ...
     * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
     * @param {number} [length] Message length if known beforehand
     * @returns {TokenTransfer} TokenTransfer
     * @throws {Error} If the payload is not a reader or valid buffer
     * @throws {$protobuf.util.ProtocolError} If required fields are missing
     */
    TokenTransfer.decode = function decode(reader, length) {
        if (!(reader instanceof $Reader))
            reader = $Reader.create(reader);
        var end = length === undefined ? reader.len : reader.pos + length, message = new $root.TokenTransfer();
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
            case 1:
            ...
            case 6:
                ...
                break;
            case 7:
                message.oriToken = reader.string();
                break;
            default:
                reader.skipType(tag & 7);
                break;
    ...
    TokenTransfer.verify = function verify(message) {
        ...
        if (message.oriToken != null && message.hasOwnProperty("oriToken"))
            if (!$util.isString(message.oriToken))
                return "oriToken: string expected";
        return null;
    };
    ...
    TokenTransfer.fromObject = function fromObject(object) {
        if (object instanceof $root.TokenTransfer)
            return object;
        var message = new $root.TokenTransfer();
        ...
        if (object.oriToken != null)
            message.oriToken = String(object.oriToken);
        return message;
    };
     ...
     * @memberof TokenTransfer
     * @static
     * @param {TokenTransfer} message TokenTransfer
     * @param {$protobuf.IConversionOptions} [options] Conversion options
     * @returns {Object.<string,*>} Plain object
     */
    TokenTransfer.toObject = function toObject(message, options) {
        ...
        if (message.oriToken != null && message.hasOwnProperty("oriToken"))
            object.oriToken = message.oriToken;
        return object;
    };
