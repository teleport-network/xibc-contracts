...
library ExistenceProof {
    ...
    function _decode_LeafOp(uint256 p, bytes memory bs)
        internal
        pure
        returns (LeafOp.Data memory, uint256)
    {
        uint256 pointer = p;
    ...
    function _decode_InnerOp(uint256 p, bytes memory bs)
        internal
        pure
        returns (InnerOp.Data memory, uint256)
    {
        uint256 pointer = p;
        (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(
            pointer,
     ...
     */
    function addPath(Data memory self, InnerOp.Data memory value)
        internal
        pure
    {
        /**
...
library NonExistenceProof {
    ...
    function _read_left(
         ...
         * if `r` is NULL, then only counting the number of fields.
         */
        (ExistenceProof.Data memory x, uint256 sz) = _decode_ExistenceProof(
            p,
            bs
        );
        if (isNil(r)) {
        ...
        returns (ExistenceProof.Data memory, uint256)
    {
        ...
        pointer += bytesRead;
        (ExistenceProof.Data memory r, ) = ExistenceProof._decode(
            pointer,
            bs,
            sz
        );
    ...
    function _estimate(Data memory r) internal pure returns (uint256) {
        ...
        e +=
            1 +
            ProtoBufRuntime._sz_lendelim(ExistenceProof._estimate(r.right));
        return e;
    }
...
library CommitmentProof {
    ...
    function _read_nonexist(
         ...
         */
        (
            NonExistenceProof.Data memory x,
            uint256 sz
        ) = _decode_NonExistenceProof(p, bs);
        if (isNil(r)) {
            counters[2] += 1;
        } else {
            r.nonexist = x;
    ...
    function _read_compressed(
         ...
         */
        (
            CompressedBatchProof.Data memory x,
            uint256 sz
        ) = _decode_CompressedBatchProof(p, bs);
        if (isNil(r)) {
            counters[4] += 1;
        } else {
            r.compressed = x;
        ...
        returns (NonExistenceProof.Data memory, uint256)
    {
        ...
        pointer += bytesRead;
        (NonExistenceProof.Data memory r, ) = NonExistenceProof._decode(
            pointer,
            bs,
            sz
        );
    ...
    function _decode_BatchProof(uint256 p, bytes memory bs)
        internal
        pure
        returns (BatchProof.Data memory, uint256)
    {
        uint256 pointer = p;
        (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(
            pointer,
        ...
        returns (CompressedBatchProof.Data memory, uint256)
    {
        ...
        pointer += bytesRead;
        (CompressedBatchProof.Data memory r, ) = CompressedBatchProof._decode(
            pointer,
            bs,
            sz
        );
    ...
    function _encode(
        ...
        pointer += CompressedBatchProof._encode_nested(
            r.compressed,
            pointer,
            bs
        );
    ...
    function _estimate(Data memory r) internal pure returns (uint256) {
        ...
        e +=
            1 +
            ProtoBufRuntime._sz_lendelim(ExistenceProof._estimate(r.exist));
        e +=
            1 +
            ProtoBufRuntime._sz_lendelim(
                NonExistenceProof._estimate(r.nonexist)
            );
        e += 1 + ProtoBufRuntime._sz_lendelim(BatchProof._estimate(r.batch));
        e +=
            1 +
            ProtoBufRuntime._sz_lendelim(
                CompressedBatchProof._estimate(r.compressed)
            );
        return e;
    }
...
library LeafOp {
    ...
    function _read_hash(
        ...
        PROOFS_PROTO_GLOBAL_ENUMS.HashOp x = PROOFS_PROTO_GLOBAL_ENUMS
            .decode_HashOp(tmp);
        if (isNil(r)) {
            counters[1] += 1;
        } else {
    ...
    function _read_length(
         ...
         */
        (int64 tmp, uint256 sz) = ProtoBufRuntime._decode_enum(p, bs);
        PROOFS_PROTO_GLOBAL_ENUMS.LengthOp x = PROOFS_PROTO_GLOBAL_ENUMS
            .decode_LengthOp(tmp);
        if (isNil(r)) {
            counters[4] += 1;
        } else {
    ...
    function _encode(
        ...
        if (uint256(r.prehash_key) != 0) {
            ...
            int32 _enum_prehash_key = PROOFS_PROTO_GLOBAL_ENUMS.encode_HashOp(
                r.prehash_key
            );
        ...
        if (uint256(r.prehash_value) != 0) {
            ...
            int32 _enum_prehash_value = PROOFS_PROTO_GLOBAL_ENUMS.encode_HashOp(
                r.prehash_value
            );
            pointer += ProtoBufRuntime._encode_enum(
                _enum_prehash_value,
        ...
        if (uint256(r.length) != 0) {
            ...
            int32 _enum_length = PROOFS_PROTO_GLOBAL_ENUMS.encode_LengthOp(
                r.length
            );
    ...
    function _estimate(Data memory r) internal pure returns (uint256) {
        ...
        e +=
            ...
            ProtoBufRuntime._sz_enum(
                PROOFS_PROTO_GLOBAL_ENUMS.encode_HashOp(r.hash)
            );
        e +=
            1 +
            ProtoBufRuntime._sz_enum(
                PROOFS_PROTO_GLOBAL_ENUMS.encode_HashOp(r.prehash_key)
            );
        e +=
            1 +
            ProtoBufRuntime._sz_enum(
                PROOFS_PROTO_GLOBAL_ENUMS.encode_HashOp(r.prehash_value)
            );
        e +=
            1 +
            ProtoBufRuntime._sz_enum(
                PROOFS_PROTO_GLOBAL_ENUMS.encode_LengthOp(r.length)
            );
...
library ProofSpec {
    ...
    function _decode_InnerSpec(uint256 p, bytes memory bs)
        internal
        pure
        returns (InnerSpec.Data memory, uint256)
    {
        uint256 pointer = p;
        (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(
            pointer,
    ...
    function _estimate(Data memory r) internal pure returns (uint256) {
        ...
        e +=
            1 +
            ProtoBufRuntime._sz_lendelim(InnerSpec._estimate(r.inner_spec));
    ...
    function _decode(
        ...
        while (pointer < offset + sz) {
            ...
            if (fieldId == 1) {
                ...
                pointer += _read_min_prefix_length(
                    pointer,
                    bs,
                    nil(),
                    counters
                ...
                pointer += _read_max_prefix_length(
                    pointer,
                    bs,
                    nil(),
                    counters
...
library BatchProof {
    ...
    function _decode_BatchEntry(uint256 p, bytes memory bs)
        internal
        pure
        returns (BatchEntry.Data memory, uint256)
    {
        uint256 pointer = p;
        (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(
            pointer,
    ...
    function _estimate(Data memory r) internal pure returns (uint256) {
        ...
        for (i = 0; i < r.entries.length; i++) {
            e +=
                1 +
                ProtoBufRuntime._sz_lendelim(
                    BatchEntry._estimate(r.entries[i])
                );
        }
        return e;
    }
     ...
     * @param value The value to add
     */
    function addEntries(Data memory self, BatchEntry.Data memory value)
        internal
        pure
    {
        /**
         * First resize the array. Then add the new element to the end.
         */
        BatchEntry.Data[] memory tmp = new BatchEntry.Data[](
...
library CompressedBatchProof {
    ...
    function _read_entries(
         ...
         */
        (
            CompressedBatchEntry.Data memory x,
            uint256 sz
        ) = _decode_CompressedBatchEntry(p, bs);
        if (isNil(r)) {
            counters[1] += 1;
        } else {
            r.entries[r.entries.length - counters[1]] = x;
        ...
        returns (CompressedBatchEntry.Data memory, uint256)
    {
        ...
        pointer += bytesRead;
        (CompressedBatchEntry.Data memory r, ) = CompressedBatchEntry._decode(
            pointer,
            bs,
            sz
        );
    ...
    function _encode(
        ...
        if (r.entries.length != 0) {
            for (i = 0; i < r.entries.length; i++) {
                ...
                pointer += CompressedBatchEntry._encode_nested(
                    r.entries[i],
                    pointer,
                    bs
                );
        ...
        if (r.lookup_inners.length != 0) {
            for (i = 0; i < r.lookup_inners.length; i++) {
                ...
                pointer += InnerOp._encode_nested(
                    r.lookup_inners[i],
                    pointer,
                    bs
                );
    ...
    function _estimate(Data memory r) internal pure returns (uint256) {
        ...
        for (i = 0; i < r.entries.length; i++) {
            e +=
                1 +
                ProtoBufRuntime._sz_lendelim(
                    CompressedBatchEntry._estimate(r.entries[i])
                );
        }
        for (i = 0; i < r.lookup_inners.length; i++) {
            e +=
                1 +
                ProtoBufRuntime._sz_lendelim(
                    InnerOp._estimate(r.lookup_inners[i])
                );
        }
        return e;
    }
    ...
    function addEntries(
        Data memory self,
        CompressedBatchEntry.Data memory value
    ) internal pure {
        /**
         * First resize the array. Then add the new element to the end.
         */
        CompressedBatchEntry.Data[]
            memory tmp = new CompressedBatchEntry.Data[](
                self.entries.length + 1
            );
        for (uint256 i = 0; i < self.entries.length; i++) {
            tmp[i] = self.entries[i];
     ...
     * @param value The value to add
     */
    function addLookupInners(Data memory self, InnerOp.Data memory value)
        internal
        pure
    {
        /**
         * First resize the array. Then add the new element to the end.
         */
        InnerOp.Data[] memory tmp = new InnerOp.Data[](
...
library CompressedBatchEntry {
    ...
    function _read_exist(
         ...
         */
        (
            CompressedExistenceProof.Data memory x,
            uint256 sz
        ) = _decode_CompressedExistenceProof(p, bs);
        if (isNil(r)) {
            counters[1] += 1;
        } else {
            r.exist = x;
    ...
    function _read_nonexist(
         ...
         */
        (
            CompressedNonExistenceProof.Data memory x,
            uint256 sz
        ) = _decode_CompressedNonExistenceProof(p, bs);
        if (isNil(r)) {
            counters[2] += 1;
        } else {
            r.nonexist = x;
        ...
        returns (CompressedExistenceProof.Data memory, uint256)
    {
        ...
        pointer += bytesRead;
        (CompressedExistenceProof.Data memory r, ) = CompressedExistenceProof
        ...
        returns (CompressedNonExistenceProof.Data memory, uint256)
    {
        ...
        pointer += bytesRead;
        (
            CompressedNonExistenceProof.Data memory r,

        ) = CompressedNonExistenceProof._decode(pointer, bs, sz);
        return (r, sz + bytesRead);
    }
    ...
    function _encode(
        ...
        pointer += CompressedExistenceProof._encode_nested(
            r.exist,
            pointer,
            bs
        );
        ...
        pointer += CompressedNonExistenceProof._encode_nested(
            r.nonexist,
            pointer,
            bs
        );
    ...
    function _estimate(Data memory r) internal pure returns (uint256) {
        ...
        e +=
            1 +
            ProtoBufRuntime._sz_lendelim(
                CompressedExistenceProof._estimate(r.exist)
            );
        e +=
            1 +
            ProtoBufRuntime._sz_lendelim(
                CompressedNonExistenceProof._estimate(r.nonexist)
            );
        return e;
    }
...
library CompressedNonExistenceProof {
    ...
    function _estimate(Data memory r) internal pure returns (uint256) {
        ...
        e +=
            1 +
            ProtoBufRuntime._sz_lendelim(
                CompressedExistenceProof._estimate(r.left)
            );
        e +=
            1 +
            ProtoBufRuntime._sz_lendelim(
                CompressedExistenceProof._estimate(r.right)
            );
        return e;
    }
