...
library RemoteContractCall {
    ...
    function _decode(
        ...
        while (pointer < offset + sz) {
            ...
            if (fieldId == 1) {
                ...
                pointer += _read_contractAddress(pointer, bs, r, counters);
            } else if (fieldId == 5) {
     ...
     * @return The number of bytes decoded
     */
    function _read_contractAddress(
        uint256 p,
        bytes memory bs,
        Data memory r,
        uint256[6] memory counters
    ...
    function _encode(
        ...
        if (bytes(r.contractAddress).length != 0) {
            pointer += ProtoBufRuntime._encode_key(
                4,
                ProtoBufRuntime.WireType.LengthDelim,
                pointer,
    ...
    function _estimate(Data memory r) internal pure returns (uint256) {
        ...
        e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.contractAddress).length);
