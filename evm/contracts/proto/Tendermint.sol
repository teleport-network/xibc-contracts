...
library ClientState {
    ...
    function _decode_Fraction(uint256 p, bytes memory bs)
        internal
        pure
        returns (Fraction.Data memory, uint256)
    {
        uint256 pointer = p;
    ...
    function _decode_Height(uint256 p, bytes memory bs)
        internal
        pure
        returns (Height.Data memory, uint256)
    {
        uint256 pointer = p;
        (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(
            pointer,
    ...
    function _decode_ProofSpec(uint256 p, bytes memory bs)
        internal
        pure
        returns (ProofSpec.Data memory, uint256)
    {
        uint256 pointer = p;
        (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(
            pointer,
    ...
    function _decode_MerklePrefix(uint256 p, bytes memory bs)
        internal
        pure
        returns (MerklePrefix.Data memory, uint256)
    {
        uint256 pointer = p;
        (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(
            pointer,
    ...
    function _encode(
        ...
        if (r.proof_specs.length != 0) {
            for (i = 0; i < r.proof_specs.length; i++) {
                ...
                pointer += ProofSpec._encode_nested(
                    r.proof_specs[i],
                    pointer,
                    bs
                );
    ...
    function _estimate(Data memory r) internal pure returns (uint256) {
        ...
        e +=
            1 +
            ProtoBufRuntime._sz_lendelim(Fraction._estimate(r.trust_level));
        ...
        e +=
            1 +
            ProtoBufRuntime._sz_lendelim(Height._estimate(r.latest_height));
        for (i = 0; i < r.proof_specs.length; i++) {
            e +=
                1 +
                ProtoBufRuntime._sz_lendelim(
                    ProofSpec._estimate(r.proof_specs[i])
                );
        }
        e +=
            1 +
            ProtoBufRuntime._sz_lendelim(
                MerklePrefix._estimate(r.merkle_prefix)
            );
     ...
     */
    function addProofSpecs(Data memory self, ProofSpec.Data memory value)
        internal
        pure
    {
        /**
         ...
         */
        ProofSpec.Data[] memory tmp = new ProofSpec.Data[](
...
library Header {
    ...
    function _encode(
        ...
        pointer += ValidatorSet._encode_nested(
    ...
    function _estimate(Data memory r) internal pure returns (uint256) {
        ...
        e +=
            1 +
            ProtoBufRuntime._sz_lendelim(
                SignedHeader._estimate(r.signed_header)
            );
        e +=
            1 +
            ProtoBufRuntime._sz_lendelim(
                ValidatorSet._estimate(r.validator_set)
            );
        e +=
            1 +
            ProtoBufRuntime._sz_lendelim(Height._estimate(r.trusted_height));
        e +=
            1 +
            ProtoBufRuntime._sz_lendelim(
                ValidatorSet._estimate(r.trusted_validators)
            );
        return e;
    }
