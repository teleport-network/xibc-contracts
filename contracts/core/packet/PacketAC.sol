...
contract PacketAC is Initializable, OwnableUpgradeable, IPacket, PausableUpgradeable, ReentrancyGuardUpgradeable {
    using Strings for *;
    using Bytes for *;
    ...
    IClientManagerAC public clientManager;
    ...
    function initialize(
        ...
        require(
            bytes(_chainName).length > 0 &&
                ...
                !_chainName.equals(_relayChainName) &&
        ...
        clientManager = IClientManagerAC(_clientManagerContract);
    ...
    function acknowledgePacket(
        ...
        // if one hops packet, deliver the packet fee to relayer directly
        if (packet.dstChain.equals(relayChainName)) {
    ...
    /**
     * @notice claim two hops packet relay fee
    ...
    function addPacketFee(
        ...
        // if two hops packet, update the remaining fee amount
