...
library BlockID {
    ...
    function _read_part_set_header(
         ...
         * if `r` is NULL, then only counting the number of fields.
         */
        (PartSetHeader.Data memory x, uint256 sz) = _decode_PartSetHeader(
            p,
            bs
        );
        if (isNil(r)) {
        ...
        returns (PartSetHeader.Data memory, uint256)
    {
        ...
        pointer += bytesRead;
        (PartSetHeader.Data memory r, ) = PartSetHeader._decode(
            pointer,
            bs,
            sz
        );
    ...
    function _estimate(Data memory r) internal pure returns (uint256) {
        ...
        e +=
            ...
            ProtoBufRuntime._sz_lendelim(
                PartSetHeader._estimate(r.part_set_header)
            );
        return e;
    }
...
library TmHeader {
    ...
    function _decode_Consensus(uint256 p, bytes memory bs)
        internal
        pure
        returns (Consensus.Data memory, uint256)
    {
        uint256 pointer = p;
        (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(
            pointer,
    ...
    function _decode_Timestamp(uint256 p, bytes memory bs)
        internal
        pure
        returns (Timestamp.Data memory, uint256)
    {
        uint256 pointer = p;
        (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(
            pointer,
    ...
    function _decode_BlockID(uint256 p, bytes memory bs)
        internal
        pure
        returns (BlockID.Data memory, uint256)
    {
        uint256 pointer = p;
        (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(
            pointer,
    ...
    function _estimate(Data memory r) internal pure returns (uint256) {
        ...
        e +=
            1 +
            ProtoBufRuntime._sz_lendelim(BlockID._estimate(r.last_block_id));
...
library Vote {
    ...
    function _read_typ(
        ...
        TYPES_PROTO_GLOBAL_ENUMS.SignedMsgType x = TYPES_PROTO_GLOBAL_ENUMS
    ...
    function _encode(
        ...
        if (uint256(r.typ) != 0) {
            ...
            int32 _enum_typ = TYPES_PROTO_GLOBAL_ENUMS.encode_SignedMsgType(
                r.typ
            );
    ...
    function _estimate(Data memory r) internal pure returns (uint256) {
        ...
        e +=
            ...
            ProtoBufRuntime._sz_enum(
                TYPES_PROTO_GLOBAL_ENUMS.encode_SignedMsgType(r.typ)
            );
        e += 1 + ProtoBufRuntime._sz_int64(r.height);
...
library Commit {
    ...
    function _decode_CommitSig(uint256 p, bytes memory bs)
        internal
        pure
        returns (CommitSig.Data memory, uint256)
    {
        uint256 pointer = p;
        (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(
            pointer,
    ...
    function _encode(
        ...
        if (r.signatures.length != 0) {
            for (i = 0; i < r.signatures.length; i++) {
                ...
                pointer += CommitSig._encode_nested(
                    r.signatures[i],
                    pointer,
                    bs
                );
    ...
    function _estimate(Data memory r) internal pure returns (uint256) {
        ...
        for (i = 0; i < r.signatures.length; i++) {
            e +=
                1 +
                ProtoBufRuntime._sz_lendelim(
                    CommitSig._estimate(r.signatures[i])
                );
        }
        return e;
    }
     ...
     */
    function addSignatures(Data memory self, CommitSig.Data memory value)
        internal
        pure
    {
        /**
         ...
         */
        CommitSig.Data[] memory tmp = new CommitSig.Data[](
            self.signatures.length + 1
        );
...
library CommitSig {
    ...
    function _read_block_id_flag(
         ...
         */
        (int64 tmp, uint256 sz) = ProtoBufRuntime._decode_enum(p, bs);
        TYPES_PROTO_GLOBAL_ENUMS.BlockIDFlag x = TYPES_PROTO_GLOBAL_ENUMS
            .decode_BlockIDFlag(tmp);
        if (isNil(r)) {
            counters[1] += 1;
        } else {
            r.block_id_flag = x;
    ...
    function _encode(
        ...
        if (uint256(r.block_id_flag) != 0) {
            ...
            int32 _enum_block_id_flag = TYPES_PROTO_GLOBAL_ENUMS
    ...
    function _estimate(Data memory r) internal pure returns (uint256) {
        ...
        e +=
            1 +
            ProtoBufRuntime._sz_enum(
                TYPES_PROTO_GLOBAL_ENUMS.encode_BlockIDFlag(r.block_id_flag)
            );
        e += 1 + ProtoBufRuntime._sz_lendelim(r.validator_address.length);
        e += 1 + ProtoBufRuntime._sz_lendelim(Timestamp._estimate(r.timestamp));
        e += 1 + ProtoBufRuntime._sz_lendelim(r.signature.length);
...
library SignedHeader {
    ...
    function _decode_TmHeader(uint256 p, bytes memory bs)
        internal
        pure
        returns (TmHeader.Data memory, uint256)
    {
        uint256 pointer = p;
        (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(
            pointer,
    ...
    function _decode_Commit(uint256 p, bytes memory bs)
        internal
        pure
        returns (Commit.Data memory, uint256)
    {
        uint256 pointer = p;
        (uint256 sz, uint256 bytesRead) = ProtoBufRuntime._decode_varint(
            pointer,
...
library CanonicalBlockID {
    ...
    function _read_part_set_header(
         ...
         */
        (
            CanonicalPartSetHeader.Data memory x,
            uint256 sz
        ) = _decode_CanonicalPartSetHeader(p, bs);
        if (isNil(r)) {
            counters[2] += 1;
        } else {
            r.part_set_header = x;
        ...
        returns (CanonicalPartSetHeader.Data memory, uint256)
    {
        ...
        pointer += bytesRead;
        (CanonicalPartSetHeader.Data memory r, ) = CanonicalPartSetHeader
    ...
    function _encode(
        ...
        pointer += CanonicalPartSetHeader._encode_nested(
            r.part_set_header,
            pointer,
            bs
        );
    ...
    function _estimate(Data memory r) internal pure returns (uint256) {
        ...
        e +=
            1 +
            ProtoBufRuntime._sz_lendelim(
                CanonicalPartSetHeader._estimate(r.part_set_header)
            );
        return e;
    }
...
library CanonicalVote {
    ...
    function _read_block_id(
         ...
         * if `r` is NULL, then only counting the number of fields.
         */
        (CanonicalBlockID.Data memory x, uint256 sz) = _decode_CanonicalBlockID(
            p,
            bs
        );
        if (isNil(r)) {
        ...
        returns (CanonicalBlockID.Data memory, uint256)
    {
        ...
        pointer += bytesRead;
        (CanonicalBlockID.Data memory r, ) = CanonicalBlockID._decode(
            pointer,
            bs,
            sz
        );
    ...
    function _estimate(Data memory r) internal pure returns (uint256) {
        ...
        e +=
            1 +
            ProtoBufRuntime._sz_lendelim(
                CanonicalBlockID._estimate(r.block_id)
            );
        e += 1 + ProtoBufRuntime._sz_lendelim(Timestamp._estimate(r.timestamp));
        e += 1 + ProtoBufRuntime._sz_lendelim(bytes(r.chain_id).length);
        return e;
