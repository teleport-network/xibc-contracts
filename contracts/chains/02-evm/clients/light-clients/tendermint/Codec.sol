...
library ClientStateCodec {
     ...
     */
    function decode(ClientState.Data storage state, bytes memory clientStateBz) public {
...
library ConsensusStateCodec {
     ...
     */
    function decode(bytes memory consensusStateBz) public pure returns (ConsensusState.Data memory) {
...
library HeaderCodec {
     ...
     */
    function decode(bytes memory headerBz) public pure returns (Header.Data memory) {
...
library ProofCodec {
     ...
     */
    function decode(bytes memory proofBz) public pure returns (MerkleProof.Data memory) {
