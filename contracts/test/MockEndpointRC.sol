...
contract MockEndpointRC is Initializable, IEndpoint, OwnableUpgradeable, ReentrancyGuardUpgradeable {
    using Strings for *;
    using Bytes for *;
     ...
     */
    function initialize(address _packetContractAddress, address _accessManagerContractAddress) public initializer {
        require(
            _packetContractAddress != address(0) && _accessManagerContractAddress != address(0),
    ...
    function bindToken(
        ...
        require(!oriChain.equals(packetContract.chainName()), "oriChain can't equal to nativeChainName");
