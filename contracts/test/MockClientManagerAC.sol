...
contract MockClientManagerAC is Initializable, OwnableUpgradeable, IClientManagerAC {
    // relay chain client
    ...
    uint256 public version; // used for upgrade test

    /**
     * @notice used for upgrade test
     */
